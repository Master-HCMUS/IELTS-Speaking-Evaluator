...
class MenuSystem:
    ...
    def display_main_menu(self) -> None:
        ...
        print("  [6] Assess with Local Fine-tuned Model")
        print("  [7] Evaluate Against SpeechOcean762 Dataset")
        print("  [8] List Audio Devices")
        print("  [9] Select Audio Device")
        print("  [10] Configure Audio Settings")
        print("  [11] Configure Azure OpenAI")
        print("  [12] Configure Local Whisper Model")
        print("  [13] Switch Transcription Service")
        print("  [14] Show Transcription Service Status")
        print("  [15] View All Settings")
        print("  [16] Test Transcription Service")
        print("  [h] Help")
        print("  [q] Quit")
        print()
